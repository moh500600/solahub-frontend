...
export default function chatbot() {
  ...
  return (
    <div className="flex h-screen bg-gray-50">
      <Sidebar activeTab="chatbot" setActiveTab={() => {}} navigateToPage={() => {}} resetAllData={() => {}} />
        ...
        <div className="p-8 space-y-6">
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-600 mt-1">إدارة وتنظيم chatbot</p>
            </div>
          ...
          <Card>
            <CardHeader>
              <CardTitle>قائمة chatbot</CardTitle>
