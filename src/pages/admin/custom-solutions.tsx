...
export default function customSolutions() {
  ...
  return (
    <div className="flex h-screen bg-gray-50">
      <Sidebar activeTab="custom-solutions" setActiveTab={() => {}} navigateToPage={() => {}} resetAllData={() => {}} />
      ...
      <main className="flex-1 overflow-auto">
        <div className="p-8 space-y-6">
          ...
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-3xl font-bold text-gray-900">custom solutions</h1>
              <p className="text-gray-600 mt-1">إدارة وتنظيم custom solutions</p>
            </div>
          ...
          <Card>
            <CardHeader>
              <CardTitle>قائمة custom solutions</CardTitle>
