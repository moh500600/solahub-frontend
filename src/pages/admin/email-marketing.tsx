...
export default function emailMarketing() {
  ...
  return (
    <div className="flex h-screen bg-gray-50">
      <Sidebar activeTab="email-marketing" setActiveTab={() => {}} navigateToPage={() => {}} resetAllData={() => {}} />
        ...
        <div className="p-8 space-y-6">
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-600 mt-1">إدارة وتنظيم email marketing</p>
            </div>
          ...
          <Card>
            <CardHeader>
              <CardTitle>قائمة email marketing</CardTitle>
