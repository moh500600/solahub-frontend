...
export default function logisticsDelivery() {
  ...
  return (
    <div className="flex h-screen bg-gray-50">
      <Sidebar activeTab="logistics-delivery" setActiveTab={() => {}} navigateToPage={() => {}} resetAllData={() => {}} />
        ...
        <div className="p-8 space-y-6">
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-600 mt-1">إدارة وتنظيم logistics delivery</p>
            </div>
          ...
          <Card>
            <CardHeader>
              <CardTitle>قائمة logistics delivery</CardTitle>
