    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
      ...
      <main className="container mx-auto px-4 py-12">
        ...
        <div className="mb-12 text-center">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">الشروط والأحكام</h1>
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">الشروط والأحكام والسياسات القانونية</p>
        </div>
