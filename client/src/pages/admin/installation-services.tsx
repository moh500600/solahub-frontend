...
export default function installationServices() {
  ...
  return (
    <div className="flex h-screen bg-gray-50">
      <Sidebar activeTab="installation-services" setActiveTab={() => {}} navigateToPage={() => {}} resetAllData={() => {}} />
        ...
        <div className="p-8 space-y-6">
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-600 mt-1">إدارة وتنظيم installation services</p>
            </div>
          ...
          <Card>
            <CardHeader>
              <CardTitle>قائمة installation services</CardTitle>
