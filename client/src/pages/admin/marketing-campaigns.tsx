...
export default function marketingCampaigns() {
  ...
  return (
    <div className="flex h-screen bg-gray-50">
      <Sidebar activeTab="marketing-campaigns" setActiveTab={() => {}} navigateToPage={() => {}} resetAllData={() => {}} />
        ...
        <div className="p-8 space-y-6">
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-600 mt-1">إدارة وتنظيم marketing campaigns</p>
            </div>
          ...
          <Card>
            <CardHeader>
              <CardTitle>قائمة marketing campaigns</CardTitle>
