...
export default function afterSales() {
  ...
  return (
    <div className="flex h-screen bg-gray-50">
      <Sidebar activeTab="after-sales" setActiveTab={() => {}} navigateToPage={() => {}} resetAllData={() => {}} />
      ...
      <main className="flex-1 overflow-auto">
        <div className="p-8 space-y-6">
          ...
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-3xl font-bold text-gray-900">after sales</h1>
              <p className="text-gray-600 mt-1">إدارة وتنظيم after sales</p>
            </div>
          ...
          <Card>
            <CardHeader>
              <CardTitle>قائمة after sales</CardTitle>
