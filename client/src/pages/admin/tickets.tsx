...
export default function tickets() {
  ...
  return (
    <div className="flex h-screen bg-gray-50">
      <Sidebar activeTab="tickets" setActiveTab={() => {}} navigateToPage={() => {}} resetAllData={() => {}} />
        ...
        <div className="p-8 space-y-6">
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-600 mt-1">إدارة وتنظيم tickets</p>
            </div>
          ...
          <Card>
            <CardHeader>
              <CardTitle>قائمة tickets</CardTitle>
