...
export default function appNotifications() {
  ...
  return (
    <div className="flex h-screen bg-gray-50">
      <Sidebar activeTab="app-notifications" setActiveTab={() => {}} navigateToPage={() => {}} resetAllData={() => {}} />
      ...
      <main className="flex-1 overflow-auto">
        <div className="p-8 space-y-6">
          ...
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-3xl font-bold text-gray-900">app notifications</h1>
              <p className="text-gray-600 mt-1">إدارة وتنظيم app notifications</p>
            </div>
          ...
          <Card>
            <CardHeader>
              <CardTitle>قائمة app notifications</CardTitle>
