...
export default function inquiries() {
  ...
  return (
    <div className="flex h-screen bg-gray-50">
      <Sidebar activeTab="inquiries" setActiveTab={() => {}} navigateToPage={() => {}} resetAllData={() => {}} />
        ...
        <div className="p-8 space-y-6">
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-600 mt-1">إدارة وتنظيم inquiries</p>
            </div>
          ...
          <Card>
            <CardHeader>
              <CardTitle>قائمة inquiries</CardTitle>
