...
export default function warrantyAnalytics() {
  ...
  return (
    <div className="flex h-screen bg-gray-50">
      <Sidebar activeTab="warranty-analytics" setActiveTab={() => {}} navigateToPage={() => {}} resetAllData={() => {}} />
      ...
      <main className="flex-1 overflow-auto">
        <div className="p-8 space-y-6">
          ...
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-3xl font-bold text-gray-900">warranty analytics</h1>
              <p className="text-gray-600 mt-1">إدارة وتنظيم warranty analytics</p>
            </div>
          ...
          <Card>
            <CardHeader>
              <CardTitle>قائمة warranty analytics</CardTitle>
